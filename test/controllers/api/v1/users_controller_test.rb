...
class Api::V1::UsersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should not create a user with an email that is taken" do
  ...
  test "should forbid update to user" do
    patch api_v1_user_url(@user), 
      params: { user: { email: @user.email } }, as: :json
    assert_response :forbidden
  end

  test "should not update user when params are not valid" do
    patch api_v1_user_url(@user), 
